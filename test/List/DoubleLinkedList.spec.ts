...
describe('DoubleLinkedList', () => {
    ...
    it('append', () => {
        ...
        expect(doubleLinkedList.getHead().getValue()).to.equal(1);
        ...
        expect(someNode.getPrevious().getValue()).to.equal(1);

        expect(someNode.getNext().getValue()).to.equal(3);

        doubleLinkedList.append(4);

        expect(doubleLinkedList.getLast().getValue()).to.equal(4);
    ...
    it('toArray()', () => {
        ...
        doubleLinkedList.append(3);
        doubleLinkedList.append(4);
        expect(doubleLinkedList.toArray()).deep.equal([1, 2, 3, 4]);
